        ...
        <div className={"dx-card responsive-paddings"}>
          ...
          <ul>
            <li>
              <a
                href={
                  "https://js.devexpress.com/Documentation/Guide/Widgets/DataGrid/Overview/"
                }
                target={"_blank"}
                rel={"noopener noreferrer"}
              >
          ...
          <ul>
            <li>
              <a
                href={
                  "https://js.devexpress.com/Documentation/Guide/React_Components/Create_a_DevExtreme_Application/#Layouts"
                }
                target={"_blank"}
                rel={"noopener noreferrer"}
              >
            ...
            <li>
              <a
                href={
                  "https://js.devexpress.com/Documentation/Guide/React_Components/Create_a_DevExtreme_Application/#Add_a_New_View"
                }
                target={"_blank"}
                rel={"noopener noreferrer"}
              >
            ...
            <li>
              <a
                href={
                  "https://js.devexpress.com/Documentation/Guide/React_Components/Create_a_DevExtreme_Application/#Configure_the_Navigation_Menu"
                }
                target={"_blank"}
                rel={"noopener noreferrer"}
              >
            ...
            <li>
              <a
                href={
                  "https://js.devexpress.com/Documentation/Guide/React_Components/Create_a_DevExtreme_Application/#Configure_Themes"
                }
                target={"_blank"}
                rel={"noopener noreferrer"}
              >
